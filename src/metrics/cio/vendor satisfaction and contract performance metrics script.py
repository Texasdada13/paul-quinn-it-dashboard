...
# Define key vendor satisfaction and contract performance metrics
vendor_metrics = [
...
# Example vendor dataset and values for demonstration
...
for metric, description in vendor_metrics:
    for vendor in vendors:
        ...
        if 'Score' in metric or 'Innovation' in metric:
            ...
            example = f"{np.random.uniform(-0.05, 0.15)*100:.1f}%"
        else:
            example = 'N/A'
